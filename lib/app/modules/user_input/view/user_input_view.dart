import 'package:git_api/widget/Container_Widget.dart';
import 'package:git_api/widget/ElevatedButton_Widget.dart';
import 'package:git_api/widget/KAppBar.dart';
...
class UserInputView extends GetView<UserInputController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const KAppBar(title: "My App"),
      body: Center(
